...
public class consultaFisica extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        FisicaDAO fisic = new FisicaDAO();
        
        String nomeCompleto     = request.getParameter("valor");
        String cpf              = request.getParameter("valor");
        
        Fisica fis = new Fisica(nomeCompleto, cpf, "","","","","","","","","","","","");
        
        List<Fisica> lisFisc = fisic.consultar(fis);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (Fisica f : lisFisc) {
                out.println("<td>" + f.getCpf() + "</td>");
                out.println("<td>" + f.getNomeCompleto() + "</td>");
                out.println("<td>" + f.getDataNascimento()+ "</td>");
                out.println("<td>" + f.getSexo()+ "</td>");
                
                out.println("<td>" + f.getEmail()+ "</td>");
                out.println("<td>" + f.getTelefoneCel()+ "</td>");
                out.println("<td>" + f.getTelefoneFixo()+ "</td>");
                
                out.println("<td>" + f.getLogradouro()+ "</td>");
                out.println("<td>" + f.getNumero()+ "</td>");
                out.println("<td>" + f.getCep()+ "</td>");
                out.println("<td>" + f.getComplemento()+ "</td>");
                out.println("<td>" + f.getCidade()+ "</td>");
                out.println("<td>" + f.getBairro()+ "</td>");
                out.println("<td>" + f.getEstado()+ "</td>");
                ...
                out.println("<label class='col-md-4 control-label'></label>");
                out.println("<div class='col-md-4'>");
                out.println("<form  name='ConProd' action='deletaFisica' method='POST'>");
                out.println("<button name='idProduto' value="+f.getCpf()+" class='btn btn-danger'>Excluir</button>");
                out.println("</form>");
                out.println("</div>");
                out.println("</div>");
                out.println("</td>");
