...
public class consultaJuridica extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        JuridicaDAO fisic = new JuridicaDAO();
        
        String RazaoSocial     = request.getParameter("valor");
        String cnpj              = request.getParameter("valor");
        
        Juridica jur = new Juridica(cnpj, RazaoSocial, "", "", "", "", "", "", "", "", "", "");
        
        List<Juridica> lisJuri = fisic.consultar(jur);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (Juridica j : lisJuri) {
                out.println("<td>" + j.getCnpj() + "</td>");
                out.println("<td>" + j.getRazaoSocial() + "</td>");
                
                out.println("<td>" + j.getEmail()+ "</td>");
                out.println("<td>" + j.getTelefoneCel()+ "</td>");
                out.println("<td>" + j.getTelefoneFixo()+ "</td>");
                
                out.println("<td>" + j.getLogradouro()+ "</td>");
                out.println("<td>" + j.getNumero()+ "</td>");
                out.println("<td>" + j.getCep()+ "</td>");
                out.println("<td>" + j.getComplemento()+ "</td>");
                out.println("<td>" + j.getCidade()+ "</td>");
                out.println("<td>" + j.getBairro()+ "</td>");
                out.println("<td>" + j.getEstado()+ "</td>");
                ...
                out.println("<label class='col-md-4 control-label'></label>");
                out.println("<div class='col-md-4'>");
                out.println("<form  name='ConProd' action='deletaJuridica' method='POST'>");
                out.println("<button name='idProduto' value="+j.getCnpj()+" class='btn btn-danger'>Excluir</button>");
                out.println("</form>");
                out.println("</div>");
                out.println("</div>");
                out.println("</td>");
