...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" name="CadProd" action="alteraProduto" method="POST">

            <div class="container marketing">
                <div class="form-group">
                    <div class="col-md-12"><label class="control-label1">Alterar produto</label></div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label" for="textinput">Nome:</label>
                    <div class="col-md-4 col-sm-8">
                        <input id="firstName" name="nomeProduto" class="form-control" type="text"  placeholder=""/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <input id="firstName" name="descricao" class="form-control" type="text"  placeholder=""/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label" for="textinput">Categoria:</label>
                    <div class="col-md-4 col-sm-8">
                        <input id="firstName"  name="categoria" class="form-control" type="text"  placeholder=""/>
                    </div>

                    <label class="col-md-1 control-label" for="textinput">Preço:</label>
                    <div class="col-md-2 col-sm-12">
                        <input id="lastName"  name="preco" class="form-control" type="text" onBlur="ValidaMoedas(CadProd.preco);" 
                    ...
                    <div class="col-md-1 col-sm-12">
                        <input id="lastName"  name="idProduto" required class="form-control" type="text" placeholder=""  />
                    </div>
                </div>
