...
<html>
    ...
    <body>
        ...
        <hr class="featurette-divider">
        <form class="form-horizontal" name="CadFunc" action="alteraFuncionario" method="POST">
            <div class="container marketing">
                <div class="form-group">
                    <div class="col-md-12"><label class="control-label1">Alterar dados do funcionario</label></div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label"  for="textinput">CPF:</label>
                    <div class="col-md-3 col-sm-10">
                        <input class="form-control" type="text"  name="cpf" onBlur="ValidarCPF(CadFunc.cpf);" 
                    ...
                    <div class="col-md-3 col-sm-10">
                        <input id="firstName" name="matricula"  class="form-control" type="text"  placeholder="00000-0" 
            ...
            <div class="container marketing">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-10">
                        <input id="firstName" name="nomeCompleto"  class="form-control" type="text"  placeholder=""/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-8">
                        <input id="firstName" name="cargo"  class="form-control" type="text"  placeholder=""/>
                    </div>
                </div>


                <div class="form-group">
                    <div class="col-md-12"><label class="control-label1">Deseja trocar a senha? </label></div>
                </div>
<div class="form-group">
                    <label class="col-md-2 control-label" for="textinput">Senha:</label>
                    <div class="col-md-2 col-sm-12">
                        <input id="lastName" name="senha"  class="form-control" type="password" placeholder="" />
                    </div>

                    <label class="col-md-2 control-label" for="textinput">Confirma Senha:</label>
                    <div class="col-md-2 col-sm-12">
                        <input id="lastName" name="confsenha"  class="form-control" type="password" placeholder="" />
                    </div>
                </div>
            </div>
