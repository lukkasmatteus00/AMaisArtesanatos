...
<html>
    ...
    <body>
        ...
        <hr class="featurette-divider">
        <form class="form-horizontal" name="CadFunc" action="adicionaClienteJuridica" method="POST">
            ...
            <div class="container marketing">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-8">
                        <input id="firstName" name="razaoSocial" required class="form-control" type="text"  placeholder=""/>
                    </div>

                    <label class="col-md-1 control-label" for="textinput">CNPJ:</label>
                    <div class="col-md-4 col-sm-12">
                        <input class="form-control" type="text" required name="cnpj" onBlur="ValidarCNPJ(CadFunc.cnpj);" 
                               onKeyPress="MascaraCNPJ(CadFunc.cnpj);" maxlength="18" placeholder="00.000.000/0000-00" />
                    </div>
                </div>
            </div>
