...
<html>
    ...
    <body>
        ...
        <div class="container marketing">
            ...
            <div class="form-group">
                <form class="form-horizontal" name="ConProd" action="consultarFuncionario" method="POST">
                    <div class="col-md-7 col-sm-7">
                        <div class="input-group">
                            <input type="text" name="valor" class="form-control" placeholder="CPF, NOME OU MATRICULA">
            ...
            <div class="form-group">
                <div class="col-md-offset-7 ">
                    ...
                    <div class="col-md-1">
                        <a class="btn btn-primary" href="adicionarFuncionario.jsp" role="button">Novo cadastro</a>
                    </div>
                    <label class="col-md-4 control-label" ></label>
                    <div class="col-md-4">
                        <a class="btn btn-primary" href="consultaListaFuncionario" role="button">Listar todos os funcionarios</a>
                    </div>
                    </div>
            </div>
            </div>
