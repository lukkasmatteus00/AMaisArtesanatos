...
<html>
    ...
    <body>
        ...
        <div class="container marketing">
            ...
            <div class="form-group">
                <form class="form-horizontal" name="ConProd" action="consultaFisica" method="POST">
                    <div class="col-md-7 col-sm-7">
                        <div class="input-group">
                            <input type="text" name="valor" class="form-control" placeholder="CPF OU NOME">
            ...
            <div class="form-group">
                <div class="col-md-offset-7 ">
                    ...
                    <div class="col-md-1">
                        <a class="btn btn-primary" href="adicionarClienteFisica.jsp" role="button">Novo cadastro</a>
                    </div>
                    <label class="col-md-4 control-label" ></label>
                    <div class="col-md-4">
                        <a class="btn btn-primary" href="consultaListaFisica" role="button">Listar todos os clientes</a>
                    </div>
                    </div>
            </div>
            </div>
