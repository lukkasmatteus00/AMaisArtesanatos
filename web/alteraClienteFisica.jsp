...
<html>
    ...
    <body>
        ...
        <hr class="featurette-divider">
        <form class="form-horizontal" name="CadFunc" action="alteraClienteFisica" method="POST">

            <div class="container marketing">
                <div class="form-group">
                    <div class="col-md-12"><label class="control-label1">Alterar dados do cliente</label></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <input class="form-control" type="text"  name="cpf" onBlur="ValidarCPF(CadFunc.cpf);" 
                               onKeyPress="MascaraCPF(CadFunc.cpf);"  required maxlength="14" placeholder="000.000.000-00" />
                    </div>
                </div>
                <hr class="featurette-divider">
            </div>
            <div class="container marketing">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-8">
                        <input id="firstName" name="dataNascimento" class="form-control" type="text"  placeholder="00/00/0000" onKeyPress="MascaraData(CadFunc.dataNascimento);" 
                               maxlength="10"  onBlur="ValidaData(CadFunc.dataNascimento);"/>
                    </div>
                </div>
            </div>
