...
<html>
    ...
    <body>
        ...
        <hr class="featurette-divider">
        <form class="form-horizontal" name="CadFunc" action="adicionaFuncionario" method="POST">
            ...
            <div class="container marketing">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-1 col-sm-1">
                        <input id="lastName" name="numero" maxlength="3" required class="form-control" type="text" placeholder="" />
                    </div>
